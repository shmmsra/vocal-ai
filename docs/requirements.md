...
- [ ] Milestone 1: Scaffold the real Cargo workspace (`vocalai-cli`, `vocalai-core`); pin `ort` with `coreml`/`cuda` features; set up `export/requirements.txt` with a working chatterbox + onnx env
